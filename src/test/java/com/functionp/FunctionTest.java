...
public class FunctionTest {
    ...
    public void testHttpTriggerJavaTestingVIP() throws Exception {
        ...
        final Map<String, String> queryParams = new HashMap<>();
        queryParams.put("name", "vip:World");
        doReturn(queryParams).when(req).getQueryParameters();
     ...
     */
    @Test
    public void testHttpTriggerJavaBadRequest() throws Exception {
        // Setup
        @SuppressWarnings("unchecked")
        final HttpRequestMessage<Optional<String>> req = mock(HttpRequestMessage.class);
        ...
        //pass in anything but NOT the name
        queryParams.put("otherstuff", "blahblah");
